...
//type ExtendedOperationJSONMarshaler struct {
//	Authentication Authentication `json:"authentication"`
//	Settlement     Settlement     `json:"settlement"`
//}

func (op BaseOperation) JSONMarshaler() BaseOperationJSONMarshaler {
	//if op.Authentication == nil || op.Settlement == nil {
...
//func (op ExtendedOperation) JSONMarshaler() ExtendedOperationJSONMarshaler {
//	return ExtendedOperationJSONMarshaler{
//		Authentication: op.Authentication,
//		Settlement:     op.Settlement,
//	}
//}
...
//func (op ExtendedOperation) MarshalJSON() ([]byte, error) {
//	return util.MarshalJSON(op.JSONMarshaler())
//}

//type ExtendedOperationJSONUnmarshaler struct {
...
//func (op *ExtendedOperation) DecodeJSON(b []byte, enc encoder.Encoder) error {
//	var u ExtendedOperationJSONUnmarshaler
//	err := enc.Unmarshal(b, &u)
//	if err != nil {
//		return DecorateError(err, ErrDecodeJson, *op)
//	}
